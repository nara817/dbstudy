...
CREATE SEQUENCE CUSTOMER_SEQ
    START WITH 1000
    NOCACHE;
INSERT INTO CUSTOMER_TBL(CUSTOMER_ID, CUSTOMER_NAME, ADDRESS, PHONE) VALUES (CUSTOMER_SEQ.NEXTVAL, '박지성', '영국', '000-000-000'); -- CUSTOMER 테이블 / 
...
ALTER TABLE ORDER_TBL
    ADD CONSTRAINT FK_ORDER_CUSTOMER FOREIGN KEY(CUSTOMER_ID) -- 현 테이블 칼럼
        REFERENCES CUSTOMER_TBL(CUSTOMER_ID) -- 디른 테이블 칼럼
            ON DELETE SET NULL;
ALTER TABLE ORDER_TBL
