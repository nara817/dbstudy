...
-- TO_DATE -> 날짜를 만들어주는 함수
SELECT TO_CHAR(BIRTHDATE, 'YY/MM/DD') AS "생 일"
FROM STUDENT;
...
*/ 
-- 테이블 학과명DEPARTMENT D LEFT OUTER JOIN 학생명STUDENT
...
*/
-- 학년별GRADE, AVG(HEIGHT) ROUND(AVG(HEIGHT), AVG(WEIGHT)
-- GROUP BY 학년별GRADE
-- 정렬ORDER BY 학년별GRADE 오름차순ASC;
--                                        소수 한자리                    소수 한자리
