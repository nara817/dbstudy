...
SELECT 
       ROUND(123.456)     -- 정수를 반올림 DIGIT을 생락한 반올림
     , ROUND(123.456, 1)  -- 소수 1 자리 남기고 반올림
     , ROUND(123.456, 2)  -- 소수 2 자리 남기고 반올림
...
SELECT 
     ...
     , TRUNC(123.456, 1)  -- 소수 1 자리 남기고 절사
     , TRUNC(123.456, 2)  -- 소수 2 자리 남기고 절사
     , TRUNC(123.456, -1) -- 일의 자리에서 절사(실생활: 핸드폰요금)
